...
public class GithubactionPackageImpl extends EPackageImpl implements GithubactionPackage
{
  ...
  {
    if (isInited) return (GithubactionPackage)EPackage.Registry.INSTANCE.getEPackage(GithubactionPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredGithubactionPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    GithubactionPackageImpl theGithubactionPackage = registeredGithubactionPackage instanceof GithubactionPackageImpl ? (GithubactionPackageImpl)registeredGithubactionPackage : new GithubactionPackageImpl();
   ...
   */
  @Override
  public EAttribute getPushEvent_Branches()
  {
    return (EAttribute)pushEventEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EAttribute getPushEvent_Tags()
  {
    return (EAttribute)pushEventEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EAttribute getPushEvent_BranchesIgnore()
  {
    return (EAttribute)pushEventEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EAttribute getPushEvent_TagsIgnore()
  {
    return (EAttribute)pushEventEClass.getEStructuralFeatures().get(3);
  }
   ...
   */
  @Override
  public EAttribute getPushEvent_Paths()
  {
    return (EAttribute)pushEventEClass.getEStructuralFeatures().get(4);
  }
   ...
   */
  @Override
  public EAttribute getPushEvent_PathsIgnore()
  {
    return (EAttribute)pushEventEClass.getEStructuralFeatures().get(5);
  }
   ...
   */
  @Override
  public EAttribute getPullRequestEvent_Branches()
  {
    return (EAttribute)pullRequestEventEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EAttribute getPullRequestEvent_Tags()
  {
    return (EAttribute)pullRequestEventEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EAttribute getPullRequestEvent_BranchesIgnore()
  {
    return (EAttribute)pullRequestEventEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EAttribute getPullRequestEvent_TagsIgnore()
  {
    return (EAttribute)pullRequestEventEClass.getEStructuralFeatures().get(3);
  }
   ...
   */
  @Override
  public EAttribute getPullRequestEvent_Paths()
  {
    return (EAttribute)pullRequestEventEClass.getEStructuralFeatures().get(4);
  }
   ...
   */
  @Override
  public EAttribute getPullRequestEvent_PathsIgnore()
  {
    return (EAttribute)pullRequestEventEClass.getEStructuralFeatures().get(5);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(pushEventEClass, PUSH_EVENT__BRANCHES);
    createEAttribute(pushEventEClass, PUSH_EVENT__TAGS);
    createEAttribute(pushEventEClass, PUSH_EVENT__BRANCHES_IGNORE);
    createEAttribute(pushEventEClass, PUSH_EVENT__TAGS_IGNORE);
    createEAttribute(pushEventEClass, PUSH_EVENT__PATHS);
    createEAttribute(pushEventEClass, PUSH_EVENT__PATHS_IGNORE);

    pullRequestEventEClass = createEClass(PULL_REQUEST_EVENT);
    createEAttribute(pullRequestEventEClass, PULL_REQUEST_EVENT__BRANCHES);
    createEAttribute(pullRequestEventEClass, PULL_REQUEST_EVENT__TAGS);
    createEAttribute(pullRequestEventEClass, PULL_REQUEST_EVENT__BRANCHES_IGNORE);
    createEAttribute(pullRequestEventEClass, PULL_REQUEST_EVENT__TAGS_IGNORE);
    createEAttribute(pullRequestEventEClass, PULL_REQUEST_EVENT__PATHS);
    createEAttribute(pullRequestEventEClass, PULL_REQUEST_EVENT__PATHS_IGNORE);
  ...
  public void initializePackageContents()
  {
    ...
    pushEventEClass.getESuperTypes().add(this.getEvent());
    pullRequestEventEClass.getESuperTypes().add(this.getEvent());
    scheduleEventEClass.getESuperTypes().add(this.getEvent());
    workflowDispatchEventEClass.getESuperTypes().add(this.getEvent());
    repositoryDispatchEventEClass.getESuperTypes().add(this.getEvent());
    createEventEClass.getESuperTypes().add(this.getEvent());
    deleteEventEClass.getESuperTypes().add(this.getEvent());
    deploymentEventEClass.getESuperTypes().add(this.getEvent());
    issueEventEClass.getESuperTypes().add(this.getEvent());
    labelEventEClass.getESuperTypes().add(this.getEvent());
    ...
    initEReference(getJob_Needs(), this.getJob(), null, "needs", null, 0, -1, Job.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getJob_RunsOn(), ecorePackage.getEString(), "runsOn", null, 0, 1, Job.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getJob_Outputs(), ecorePackage.getEString(), "outputs", null, 0, -1, Job.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getJob_Env(), this.getEnv(), null, "env", null, 0, -1, Job.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getJob_Defaults(), this.getRunSetting(), null, "defaults", null, 0, -1, Job.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getJob_If(), ecorePackage.getEString(), "if", null, 0, 1, Job.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getStep_If(), ecorePackage.getEString(), "if", null, 0, 1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getStep_Uses(), ecorePackage.getEString(), "uses", null, 0, 1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getStep_Run(), ecorePackage.getEString(), "run", null, 0, -1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getStep_RunSetting(), this.getRunSetting(), null, "runSetting", null, 0, 1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getStep_With(), this.getInputParameter(), null, "with", null, 0, -1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getStep_Entrypoint(), ecorePackage.getEString(), "entrypoint", null, 0, 1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getStep_Args(), ecorePackage.getEString(), "args", null, 0, 1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getStep_Env(), this.getEnv(), null, "env", null, 0, -1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(envEClass, Env.class, "Env", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getEnv_Name(), ecorePackage.getEString(), "name", null, 0, 1, Env.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getEnvironment_Url(), ecorePackage.getEString(), "url", null, 0, 1, Environment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(runSettingEClass, RunSetting.class, "RunSetting", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getRunSetting_WorkingDirectory(), ecorePackage.getEString(), "workingDirectory", null, 0, 1, RunSetting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRunSetting_Shell(), ecorePackage.getEString(), "shell", null, 0, 1, RunSetting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRunSetting_With(), this.getEnv(), null, "with", null, 0, -1, RunSetting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(pushEventEClass, PushEvent.class, "PushEvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getPushEvent_Branches(), ecorePackage.getEString(), "branches", null, 0, -1, PushEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPushEvent_Tags(), ecorePackage.getEString(), "tags", null, 0, -1, PushEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPushEvent_BranchesIgnore(), ecorePackage.getEString(), "branchesIgnore", null, 0, -1, PushEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPushEvent_TagsIgnore(), ecorePackage.getEString(), "tagsIgnore", null, 0, -1, PushEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPushEvent_Paths(), ecorePackage.getEString(), "paths", null, 0, -1, PushEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPushEvent_PathsIgnore(), ecorePackage.getEString(), "pathsIgnore", null, 0, -1, PushEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(pullRequestEventEClass, PullRequestEvent.class, "PullRequestEvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getPullRequestEvent_Branches(), ecorePackage.getEString(), "branches", null, 0, -1, PullRequestEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPullRequestEvent_Tags(), ecorePackage.getEString(), "tags", null, 0, -1, PullRequestEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPullRequestEvent_BranchesIgnore(), ecorePackage.getEString(), "branchesIgnore", null, 0, -1, PullRequestEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPullRequestEvent_TagsIgnore(), ecorePackage.getEString(), "tagsIgnore", null, 0, -1, PullRequestEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPullRequestEvent_Paths(), ecorePackage.getEString(), "paths", null, 0, -1, PullRequestEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPullRequestEvent_PathsIgnore(), ecorePackage.getEString(), "pathsIgnore", null, 0, -1, PullRequestEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(scheduleEventEClass, ScheduleEvent.class, "ScheduleEvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getScheduleEvent_Minute(), ecorePackage.getEString(), "minute", null, 0, 1, ScheduleEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getScheduleEvent_Hour(), ecorePackage.getEString(), "hour", null, 0, 1, ScheduleEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getScheduleEvent_Day(), ecorePackage.getEString(), "day", null, 0, 1, ScheduleEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getScheduleEvent_Month(), ecorePackage.getEString(), "month", null, 0, 1, ScheduleEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getScheduleEvent_DayOfWeek(), ecorePackage.getEString(), "dayOfWeek", null, 0, 1, ScheduleEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(workflowDispatchEventEClass, WorkflowDispatchEvent.class, "WorkflowDispatchEvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getWorkflowDispatchEvent_Inputs(), this.getInput(), null, "inputs", null, 0, -1, WorkflowDispatchEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(repositoryDispatchEventEClass, RepositoryDispatchEvent.class, "RepositoryDispatchEvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getRepositoryDispatchEvent_EventTypes(), ecorePackage.getEString(), "eventTypes", null, 0, -1, RepositoryDispatchEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(createEventEClass, CreateEvent.class, "CreateEvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(deleteEventEClass, DeleteEvent.class, "DeleteEvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(deploymentEventEClass, DeploymentEvent.class, "DeploymentEvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(issueEventEClass, IssueEvent.class, "IssueEvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getIssueEvent_ActivityTypes(), this.getIssueActivityType(), "activityTypes", null, 0, -1, IssueEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(labelEventEClass, LabelEvent.class, "LabelEvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getLabelEvent_ActivityTypes(), this.getLabelActivityType(), "activityTypes", null, 0, -1, LabelEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getInput_Default(), ecorePackage.getEString(), "default", null, 0, 1, Input.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
