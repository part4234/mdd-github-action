 ...
 * @generated
 */
public class WorkflowDispatchEventImpl extends EventImpl implements WorkflowDispatchEvent
{
  /**
  ...
  public EList<Input> getInputs()
  {
    if (inputs == null)
    {
      inputs = new EObjectContainmentEList<Input>(Input.class, this, GithubactionPackage.WORKFLOW_DISPATCH_EVENT__INPUTS);
    }
    return inputs;
  }
