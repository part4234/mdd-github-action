...
public class GithubactionGenerator extends AbstractGenerator {
  ...
  public String doGenerateStats(final Repository repo) {
    ...
    _builder.newLine();
    _builder.append("- ");
    int _size = IteratorExtensions.size(Iterators.<Workflow>filter(repo.eAllContents(), Workflow.class));
    _builder.append(_size);
    _builder.append(" Workflows");
    _builder.newLineIfNotEmpty();
    _builder.append("- ");
    int _size_1 = IteratorExtensions.size(Iterators.<Event>filter(repo.eAllContents(), Event.class));
    _builder.append(_size_1);
    _builder.append(" Events");
    _builder.newLineIfNotEmpty();
    _builder.append("- ");
    int _size_2 = IteratorExtensions.size(Iterators.<Job>filter(repo.eAllContents(), Job.class));
    _builder.append(_size_2);
    _builder.append(" Jobs");
    _builder.newLineIfNotEmpty();
    _builder.append("- ");
    int _size_3 = IteratorExtensions.size(Iterators.<Step>filter(repo.eAllContents(), Step.class));
