...
/**
 * This is the item provider adapter for a {@link uk.ac.kcl.inf.mdd.project.githubaction.Run} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RunItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Run_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Run_name_feature", "_UI_Run_type"),
						GithubactionPackage.Literals.RUN__NAME, true, false, false,
	...
	protected void addCommandsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Run_commands_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Run_commands_feature", "_UI_Run_type"),
						GithubactionPackage.Literals.RUN__COMMANDS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
